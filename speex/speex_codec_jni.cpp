...
JNICALL
Java_coredevices_speex_SpeexCodec_initSpeexBits(JNIEnv *env, jobject thiz) {
...
JNICALL
Java_coredevices_speex_SpeexCodec_initDecState(JNIEnv *env, jobject thiz, jlong sample_rate,
        jint bit_rate) {
...
Java_coredevices_speex_SpeexCodec_destroySpeexBits(
    JNIEnv *env,
    jobject thiz,
    jlong speex_bits
) {
...
extern "C"
JNIEXPORT void JNICALL
Java_coredevices_speex_SpeexCodec_destroyDecState(
    JNIEnv *env,
    jobject thiz,
    jlong dec_state
) {
